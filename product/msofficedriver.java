...
public class msofficedriver{
    ...
    System.out.println("the name of this file is" + w.name +"the extention is " + w.ext +"and it contains" + w.nooflines +"lines");
    System.out.println("the name of this file is" + p.name +"the extention is " + p.ext +"and it contains" + "slides");
    }
